...
from greendoge.pools.pool_config import PoolWalletConfig, load_pool_config, update_pool_config
from greendoge.pools.pool_wallet_info import (
    PoolWalletInfo,
    PoolSingletonState,
    PoolState,
    FARMING_TO_POOL,
...
from greendoge.protocols.pool_protocol import POOL_PROTOCOL_VERSION
...
from greendoge.pools.pool_puzzles import (
...
from greendoge.wallet.sign_coin_solutions import sign_coin_solutions
...
class PoolWallet:
    ...
    async def create_new_pool_wallet_transaction(
        ...
        the same pooling puzzle. This puzzle is a `greendoge singleton` that is
