...
from greendoge.types.blockchain_format.program import NIL
...
from greendoge.util.clvm import int_from_bytes, int_to_bytes
...
from greendoge.util.ints import uint32, uint64, uint16
from greendoge.wallet.puzzles.generator_loader import GENERATOR_FOR_SINGLE_COIN_MOD
from greendoge.wallet.puzzles.rom_bootstrap_generator import get_generator
...
def parse_aggsig(args: SExp) -> List[bytes]:
    ...
    # just like as_atom_list() (see greendoge/types/blockchain_format/program.py)
