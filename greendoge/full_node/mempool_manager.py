...
from greendoge.util import cached_bls
...
from greendoge.full_node.bundle_tools import simple_solution_generator
from greendoge.full_node.coin_store import CoinStore
from greendoge.full_node.mempool import Mempool
from greendoge.full_node.mempool_check_conditions import mempool_check_conditions_dict, get_name_puzzle_conditions
...
from greendoge.util.clvm import int_from_bytes
from greendoge.util.condition_tools import pkm_pairs
from greendoge.util.errors import Err
from greendoge.util.generator_tools import additions_for_npc
...
class MempoolManager:
    def __init__(self, coin_store: CoinStore, consensus_constants: ConsensusConstants):
        ...
        # transactions. This prevents spam. This is equivalent to 0.055 GDOG per block, or about 0.00005 GDOG for two
        # spends.
