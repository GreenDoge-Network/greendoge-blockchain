...
from greendoge.cmds.init_funcs import check_keys
from greendoge.consensus.block_rewards import calculate_base_farmer_reward
from greendoge.pools.pool_wallet import PoolWallet
from greendoge.pools.pool_wallet_info import create_pool_state, FARMING_TO_POOL, PoolWalletInfo, PoolState
from greendoge.protocols.protocol_message_types import ProtocolMessageTypes
from greendoge.server.outbound_message import NodeType, make_msg
...
from greendoge.util.bech32m import decode_puzzle_hash, encode_puzzle_hash
from greendoge.util.byte_types import hexstr_to_bytes
from greendoge.util.ints import uint32, uint64
from greendoge.util.keychain import bytes_to_mnemonic, generate_mnemonic
from greendoge.util.path import path_from_root
from greendoge.util.ws_message import WsRpcMessage, create_payload_dict
from greendoge.wallet.cc_wallet.cc_wallet import CCWallet
from greendoge.wallet.derive_keys import master_sk_to_singleton_owner_sk
...
from greendoge.wallet.trade_record import TradeRecord
from greendoge.wallet.transaction_record import TransactionRecord
from greendoge.wallet.util.backup_utils import download_backup, get_backup_info, upload_backup
from greendoge.wallet.util.trade_utils import trade_record_to_dict
...
from greendoge.wallet.wallet_info import WalletInfo
from greendoge.wallet.wallet_node import WalletNode
...
class WalletRpcApi:
    ...
    async def _check_key_used_for_rewards(
        ...
        farmer_target = config["farmer"].get("gdog_target_address")
        pool_target = config["pool"].get("gdog_target_address")
        found_farmer = False
        found_pool = False
    ...
    async def create_new_wallet(self, request: Dict):
        ...
        if request["wallet_type"] == "cc_wallet":
            ...
            if request["mode"] == "new":
                ...
                from greendoge.pools.pool_wallet_info import initial_pool_state_from_dict
