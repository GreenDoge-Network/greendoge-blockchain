...
from greendoge.pools.pool_config import PoolWalletConfig, load_pool_config
from greendoge.protocols import farmer_protocol, harvester_protocol
from greendoge.protocols.pool_protocol import (
    ErrorResponse,
...
from greendoge.util.bech32m import decode_puzzle_hash
from greendoge.util.byte_types import hexstr_to_bytes
from greendoge.util.config import load_config, save_config, config_path_for_filename
...
from greendoge.wallet.puzzles.singleton_top_layer import SINGLETON_MOD
...
class Farmer:
    ...
    async def setup_keys(self):
        ...
        if len(self.get_public_keys()) == 0:
            error_str = "No keys exist. Please run 'greendoge keys generate' or open the UI."
        ...
        self.pool_target_encoded = self.pool_config["gdog_target_address"]
