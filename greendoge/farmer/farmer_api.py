...
from greendoge.consensus.network_type import NetworkType
from greendoge.consensus.pot_iterations import calculate_iterations_quality, calculate_sp_interval_iters
from greendoge.farmer.farmer import Farmer
from greendoge.protocols import farmer_protocol, harvester_protocol
from greendoge.protocols.harvester_protocol import PoolDifficulty
...
from greendoge.util.api_decorators import api_request, peer_required
...
class FarmerAPI:
    ...
    async def new_proof_of_space(
        self, new_proof_of_space: harvester_protocol.NewProofOfSpace, peer: ws.WSGreenDogeConnection
    ):
        """
    ...
    @api_request
    @peer_required
    async def respond_plots(self, _: harvester_protocol.RespondPlots, peer: ws.WSGreenDogeConnection):
