...
from greendoge.cmds.init_funcs import greendoge_full_version_str
from greendoge.protocols.protocol_message_types import ProtocolMessageTypes
from greendoge.protocols.protocol_state_machine import message_response_ok
from greendoge.protocols.protocol_timing import INTERNAL_PROTOCOL_ERROR_BAN_SECONDS
from greendoge.protocols.shared_protocol import Capability, Handshake
...
from greendoge.util.ints import uint8, uint16

# Each message is prepended with LENGTH_BYTES bytes specifying the length
from greendoge.util.network import class_for_type, is_localhost
