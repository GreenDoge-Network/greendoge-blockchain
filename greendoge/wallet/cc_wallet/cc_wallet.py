...
from greendoge.consensus.cost_calculator import calculate_cost_of_program, NPCResult
...
from greendoge.protocols.wallet_protocol import PuzzleSolutionResponse
...
from greendoge.util.condition_tools import conditions_dict_for_solution, pkm_pairs_for_conditions_dict
...
from greendoge.wallet.cc_wallet.cc_info import CCInfo
from greendoge.wallet.cc_wallet.cc_utils import (
    CC_MOD,
    SpendableCC,
...
from greendoge.wallet.puzzles.genesis_by_coin_id_with_0 import (
