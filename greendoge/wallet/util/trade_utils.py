...
from greendoge.util.condition_tools import conditions_dict_for_solution
    ...
    try:
        ...
        for coinsol in trade_offer.coin_solutions:
            ...
            if r:
                ...
                if "greendoge" in cc_discrepancies:
                    cc_discrepancies["greendoge"] = cc_discrepancies["greendoge"] + diff
                else:
                    cc_discrepancies["greendoge"] = diff
