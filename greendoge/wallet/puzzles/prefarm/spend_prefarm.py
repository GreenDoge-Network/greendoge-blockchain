...
from greendoge.util.condition_tools import parse_sexp_to_conditions
from greendoge.util.config import load_config
from greendoge.util.default_root import DEFAULT_ROOT_PATH
from greendoge.util.ints import uint32, uint16
...
async def main() -> None:
    ...
    try:
        ...
        address1 = "gdog1rdatypul5c642jkeh4yp933zu3hw8vv8tfup8ta6zfampnyhjnusxdgns6"  # Key 1
        address2 = "gdog1duvy5ur5eyj7lp5geetfg84cj2d7xgpxt7pya3lr2y6ke3696w9qvda66e"  # Key 2
