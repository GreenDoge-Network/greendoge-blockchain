...
from greendoge.util.config import load_config, save_config, str2bool
...
def configure(
    ...
    if testnet is not None:
        if testnet == "true" or testnet == "t":
            ...
            testnet_dns_introducer = "dns-introducer-testnet7.greendoge.dog"
            testnet = "testnet7"
            ...
            mainnet_port = "6544"
            mainnet_introducer = "introducer.greendoge.dog"
            mainnet_dns_introducer = "dns-introducer.greendoge.dog"
            net = "mainnet"
    ...
    if change_made:
        print("Restart any running greendoge services for changes to take effect")
