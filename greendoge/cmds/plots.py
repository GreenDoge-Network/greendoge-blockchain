...
def show_plots(root_path: Path):
    from greendoge.plotting.util import get_plot_directories
...
def create_cmd(
    ...
    from greendoge.plotting.create_plots import create_plots, resolve_plot_keys
...
def remove_cmd(ctx: click.Context, final_dir: str):
    from greendoge.plotting.util import remove_plot_directory
