...
def init_cmd(ctx: click.Context, create_certs: str, fix_ssl_permissions: bool, **kwargs):
    ...
    - Make a copy of your Farming Machine CA directory: ~/.greendoge/[version]/config/ssl/ca
    - Shut down all greendoge daemon processes with `greendoge stop all -d`
    - Run `greendoge init -c [directory]` on your remote harvester,
      where [directory] is the the copy of your Farming Machine CA directory
    - Get more details on remote harvester on GreenDoge wiki:
      https://github.com/Chia-Network/chia-blockchain/wiki/Farming-on-many-machines
    """
    from pathlib import Path
    from .init_funcs import init
    from greendoge.cmds.passphrase_funcs import initialize_passphrase
