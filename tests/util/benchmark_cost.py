...
from greendoge.wallet.puzzles.p2_delegated_puzzle import puzzle_for_pk
...
def run_and_return_cost_time(greendogelisp):
    ...
    clvm_loop_solution = f"(1000 {greendogelisp})"
