...
from greendoge.server.start_full_node import SERVICE_NAME
...
from greendoge.consensus.pot_iterations import calculate_iterations_quality
from greendoge.full_node.weight_proof import (  # type: ignore
    WeightProofHandler,
