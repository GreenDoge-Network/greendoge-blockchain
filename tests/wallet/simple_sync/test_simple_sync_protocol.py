...
from greendoge.protocols import wallet_protocol, full_node_protocol
...
from greendoge.protocols.wallet_protocol import RespondToCoinUpdates, CoinStateUpdate, RespondToPhUpdates, CoinState
