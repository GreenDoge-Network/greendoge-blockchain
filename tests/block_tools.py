...
from greendoge.consensus.cost_calculator import NPCResult, calculate_cost_of_program
...
from greendoge.plotting.util import PlotInfo, PlotsRefreshParameter, PlotRefreshResult, parse_plot_info
...
from greendoge.types.condition_with_args import ConditionWithArgs
...
from greendoge.types.name_puzzle_condition import NPC
from greendoge.util.bech32m import encode_puzzle_hash
from greendoge.util.block_cache import BlockCache
from greendoge.util.condition_tools import ConditionOpcode, conditions_by_opcode
...
class BlockTools:
    ...
    async def setup_plots(self):
        ...
        try:
            ...
            plot_keys_2 = PlotKeys(self.farmer_pk, None, encode_puzzle_hash(self.pool_ph, "gdog"))
