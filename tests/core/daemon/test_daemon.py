...
from greendoge.util.block_tools import BlockTools
from greendoge.util.ints import uint16
from greendoge.util.ws_message import create_payload
...
class TestDaemon:
    ...
    async def test_daemon_simulation(self, simulation, get_daemon):
        ...
        data = {}
        payload = create_payload("get_blockchain_state", data, service_name, "greendoge_full_node")
        await ws.send_str(payload)
