...
from greendoge.pools.pool_config import PoolWalletConfig
from greendoge.util.config import load_config, save_config, create_default_greendoge_config
...
def test_pool_config():
    ...
    create_default_greendoge_config(test_root, ["config.yaml"])
