...
from greendoge.wallet.puzzles.p2_conditions import puzzle_for_conditions
from greendoge.wallet.puzzles import singleton_top_layer
from greendoge.pools.pool_wallet_info import PoolState
...
This test suite aims to test:
    - greendoge.pools.pool_puzzles.py
    - greendoge.wallet.puzzles.pool_member_innerpuz.clvm
    - greendoge.wallet.puzzles.pool_waiting_room_innerpuz.clvm
"""
