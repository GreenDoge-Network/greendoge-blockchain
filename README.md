...
GreenDoge: A new blockchain and smart transaction platform that is easier to use, more efficient, secure, and extremely low energy consumption when mining with Chia. 
