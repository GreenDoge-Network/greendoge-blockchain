...
Because of the suggestions of many people, We decided to migrate from ChiaDoge to GreenDoge Network. GreenDoge mainnet will be lauched only after fully preparing all OS versions. And let the rewards obtained by ChiaDoge can be transferred to the GreenDoge mainnet. Do not run GreenDoge testnet yourself without following the community's instructions.
