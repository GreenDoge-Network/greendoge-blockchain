...
ChiaDoge will continue to run. GreenDoge is made to improve ChiaDoge. It is currently being tested and will not promise any rewards. Don't run it yourself without following the community's instructions.
