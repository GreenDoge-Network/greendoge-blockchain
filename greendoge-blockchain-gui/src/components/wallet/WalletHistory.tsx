...
import { mojo_to_greendoge_string, mojo_to_colouredcoin_string } from '../../util/greendoge';
...
const getCols = (type: WalletType) => [
  ...
  },
  {
    field: (row: Row) => type === WalletType.COLOURED_COIN
      ...
      : mojo_to_greendoge_string(row.amount),
    title: <Trans>Amount</Trans>,
  },
  {
    field: (row: Row) => mojo_to_greendoge_string(row.fee_amount),
