...
If you want to learn more about this project, read the [wiki](https://github.com/GreenDoge-Network/greendoge-blockchain/wiki), or check out the [whitepaper](https://greendoge.dog/whitepaper).
...
We provide a [pre-commit configuration](https://github.com/GreenDoge-Network/greendoge-blockchain/blob/main/.pre-commit-config.yaml) which triggers several useful
