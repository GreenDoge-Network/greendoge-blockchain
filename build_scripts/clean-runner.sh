...
rm -rf ../venv || true
rm -rf venv || true
rm -rf greendoge_blockchain.egg-info || true
rm -rf build_scripts/final_installer || true
rm -rf build_scripts/dist || true
rm -rf build_scripts/pyinstaller || true
rm -rf greendoge-blockchain-gui/build || true
rm -rf greendoge-blockchain-gui/daemon || true
rm -rf greendoge-blockchain-gui/node_modules || true
rm greendoge-blockchain-gui/temp.json || true
( cd "$PWD/greendoge-blockchain-gui" && git checkout HEAD -- package-lock.json ) || true
cd "$PWD" || true
...
npm uninstall -g @greendoge-network/notarize-cli || true
