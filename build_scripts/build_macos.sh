...
mv GreenDoge-darwin-x64 ../build_scripts/dist/
cd ../build_scripts || exit

DMG_NAME="GreenDoge-$GREENDOGE_INSTALLER_VERSION.dmg"
echo "Create $DMG_NAME"
mkdir final_installer
electron-installer-dmg dist/GreenDoge-darwin-x64/GreenDoge.app GreenDoge-$GREENDOGE_INSTALLER_VERSION \
